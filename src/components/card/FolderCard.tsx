...
export default function FolderCard({
    ...
    return (
        ...
        >
            {/* Icon area */}
            <div className="h-[90px] bg-[#0d0d0d] flex items-center justify-center relative">
                ...
                {menuItems.length > 0 && (
                    <div className="absolute top-2 right-2">
                        <button
                            ...
                            className="w-7 h-7 flex items-center justify-center rounded-[6px] text-[#444] hover:text-[#ededed] hover:bg-white/[0.08] transition-colors"
                        >
            ...
            <div className="px-3 py-2.5">
                <p className="text-[13px] font-medium text-[#ccc] truncate" title={folder.name}>{folder.name}</p>
                <p className="text-[11px] text-[#444] mt-0.5">Dossier</p>
            </div>
        </div>
    );
}
