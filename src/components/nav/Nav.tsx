    ...
    return (
        <aside className="w-64 h-screen flex-shrink-0 bg-surface dark:bg-dark-surface border-r border-main-bg dark:border-dark-main-bg flex-col p-4 overflow-y-auto hidden md:flex">
            ...
            <div className="mb-2 px-4 mt-2">
                <span
                    className="text-xs font-bold text-txt-secondary dark:text-dark-txt-secondary tracking-wider uppercase">Paramètres</span>
            </div>
            ...
            <button className="mt-auto pt-4 border-t border-txt-secondary dark:border-dark-txt-secondary relative" >
                ...
                >
                    ...
                    <img
                        ...
                        alt="image de profil"
                    /> : 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-10 w-10 rounded-full border-2 border-transparent hover:border-action dark:hover:border-dark-action transition-all cursor-pointer object-cover">
