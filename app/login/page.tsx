                ...
                <div className="w-full max-w-[420px] bg-[#111113] border border-[#7c6ef8]/20 rounded-[20px] px-9 py-10 relative z-10 shadow-[0_40px_80px_rgba(0,0,0,0.6)]">
                    ...
                    <a href="/" className="flex items-center justify-center gap-2.5 mb-7 no-underline">
                        <svg width="32" height="32" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path fill="url(#lg-login)" d="M72 82H28C16 82 6 73 6 62C6 52 13 43.5 23 41.5C23 30 32 21 44 21C53 21 60.5 26 64 33C66 32.5 68 32 70 32C80 32 88 40 88 50C88 67 81 78 72 82Z" />
                    ...
                    <p className="text-center text-[13px] text-[#484858] font-light">
                        Pas de compte ?{" "}
                        <a href="/register" className="text-[#7c6ef8] hover:text-[#42aff0] transition-colors no-underline">
                            S'inscrire
                        </a>
                    </p>
                </div>
